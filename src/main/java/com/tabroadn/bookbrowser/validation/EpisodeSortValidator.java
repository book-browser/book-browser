...
public class EpisodeSortValidator implements ConstraintValidator<ValidEpisodeSort, String> {
  private static final List<String> VALID_SORT_FIELDS = Arrays.asList("id", "title", "description", "releaseDate");
