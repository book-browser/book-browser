...
const LoginModalContent = ({
  ...
  const onChange = (_data: LoginRequest, newValid: boolean) => {
    setValid(newValid);
  };
        ...
        <LoginForm
          ...
          footer={
            <div>
              ...
              <div className="mb-3">
                {!loading && (
                  <Button variant="primary" className="w-100" type="submit" disabled={!valid}>
                    Login
                  </Button>
                )}
                {loading && (
              ...
              <div className="text-center">
                <Button variant="link" onClick={() => setActiveTab('recover')}>
                  Forgot Username?
                </Button>
              </div>
    ...
    <RegisterForm
      ...
      footer={
        <div>
          ...
          {!loading && (
            <Button className="mb-4 w-100" variant="primary" type="submit" disabled={!valid}>
              Register
            </Button>
          )}
          {loading && (
...
const RegisterModalContent = ({
  ...
  const onChange = (_data: RegisterRequest, newValid: boolean) => {
    setValid(newValid);
  };
      ...
      <Modal.Body>
        ...
        <div>
          <Form.Group controlId="email-input">
            ...
            <Form.Control type="text" name="email-input" value={email} onChange={onChange} />
          </Form.Group>
        </div>
        <div className="mb-3">
          {!loading && (
...
const HeaderModal = ({ defaultTab, show, onHide }: HeaderModalProps) => {
